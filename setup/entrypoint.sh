...
then
    sed "s#anfisa-druid-coordinator#${ANFISA_COORD_HOST}#g" /anfisa/anfisa.json | sed "s#router#${ANFISA_ROUTER_HOST}#g" | sed "s#anfisa-mongodb#${ANFISA_MONGO_HOST}#g" -  > /anfisa/anfisa.json
fi
